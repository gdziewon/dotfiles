...
hl.bind(mainMod .. " + Return",     hl.dsp.exec_cmd(launchPrefix .. TERMINAL)) -- main + ENTER
hl.bind(mainMod .. " + E",          hl.dsp.exec_cmd(launchPrefix .. FILE_MANAGER))
hl.bind(mainMod .. " + M",          hl.dsp.exec_cmd(launchPrefix .. MUSIC)) -- useless
